...
def get_city():
    ...
    if city == 'Chicago' or city == 'C':
        ...
        print("\nI'm sorry, I'm not sure which city you're referring to. Let's try again, may be then you will get it correct.")
        return get_city()
...
def get_time_period():
    ...
    '''
    time_period = input('\nThank you, Would you like to filter the data by month, day, or not at'
